...
using TwoTenantApp.Options;

namespace TwoTenantApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddCookie(o =>
            {
                o.Cookie.Name = "TwoTenantApp.Auth";
            })
            .AddOpenIdConnect(o =>
            {
                ...
                o.Events = new OpenIdConnectEvents
                {
                    ...
                    OnTokenValidated = ctx =>
                    {
                        ...
                        string userType;
                        // NOTE: The flaw here is assuming there are only two possible tenant ids
                        // We should have an if-else if-else where else throws
